    ...
    <section id="care" className="bg-cream py-16 sm:py-20" aria-labelledby="care-preview-heading">
      <div className="section-wrap">
        <div className="text-center mb-12">
          <p className="section-label mb-3">Easy to Follow</p>
          <h2 id="care-preview-heading" className="section-heading mb-4">Care Guides</h2>
          <div className="pink-divider mb-4" />
          <p className="font-sans text-lg text-ink-light max-w-md mx-auto leading-relaxed">
            Every tree comes with a QR tag linking to its full care guide. Here&apos;s a quick look at the most popular species.
          </p>
        </div>
