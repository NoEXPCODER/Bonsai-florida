        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-2xl font-sans text-lg leading-8 text-forest/75">
              Browse available bonsai online, then book a private garden visit. Each tree will have a QR tag with price, care information, and tree details so visitors can browse with less staff assistance.
            </p>
          </div>
