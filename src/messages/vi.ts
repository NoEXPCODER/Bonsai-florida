...
export const vi: Messages = {
  admin: {
    ...
    soldBuyerLabel: 'Liên kết với lượt đặt lịch (không bắt buộc)',
    soldBuyerSearch: 'Tìm theo tên hoặc số điện thoại…',
    soldBuyerSearching: 'Đang tìm…',
    soldBuyerNone: 'Không tìm thấy lượt đặt lịch',
    soldBuyerClear: 'Xóa',
    soldBuyerLinked: 'Đã liên kết người mua:',
  ...
  customerModal: {
    title: 'Lưu Cây Yêu Thích',
    subtitle: 'Nhập tên và số điện thoại để lưu cây và đặt lịch tham quan.',
    namePlaceholder: 'Tên của bạn',
    phonePlaceholder: 'Số điện thoại',
    continueButton: 'Tiếp Tục',
    nameError: 'Vui lòng nhập tên.',
    phoneError: 'Vui lòng nhập số điện thoại.',
    staffLink: 'Nhân viên? Vào Admin →',
    signOut: 'Đăng Xuất',
  ...
  collection: {
    ...
    description:
      'Mỗi cây được chọn lọc kỹ càng cho cuộc sống miền Nam Florida. Bấm vào từng cây để xem chi tiết, cách chăm sóc, và lưu vào danh sách tham quan.',
    sunLabel: 'Ánh sáng',
    waterLabel: 'Tưới nước',
    levelLabel: 'Cấp độ',
    askButton: 'Xem Chi Tiết Cây',
  ...
  featuredTrees: {
    ...
    viewTree: 'Xem Cây',
    askAboutTree: 'Xem Chi Tiết Cây',
    saveToList: 'Lưu Vào Danh Sách',
    savedToList: 'Đã Lưu ✓',
    listFull: 'Danh Sách Đầy (5/5)',
  ...
  visitList: {
    ...
    remove: 'Xóa',
    holdPolicy: 'Cây đã lưu được chuẩn bị cho chuyến thăm nhưng chưa được đặt chỗ hoàn toàn. Cây cụ thể có thể được giữ đến giờ hẹn.',
    loginPrompt: 'Danh sách của bạn đang nghiêm túc! Lưu qua tin nhắn — nhập tên và số điện thoại:',
    saveList: 'Lưu Danh Sách',
  },
  whyBonsai: {
    label: 'Tại Sao Bonsai Florida',
    heading: 'Trồng Cho Cuộc Sống Miền Nam Florida',
    items: [
      { icon: '🌿', title: 'Bonsai Nhiệt Đới Trồng Tại Florida', desc: 'Mỗi cây trong bộ sưu tập được chọn lọc và chăm sóc ngay tại Palm Beach.' },
      { icon: '🌱', title: 'Chăm Sóc Thân Thiện Người Mới', desc: 'Chúng tôi chỉ bán các loài phát triển tốt trong khí hậu Florida.' },
      { icon: '📱', title: 'Hướng Dẫn QR Kèm Theo Mỗi Cây', desc: 'Quét thẻ để xem hướng dẫn chăm sóc đầy đủ, lịch tưới nước và ánh sáng.' },
      { icon: '📍', title: 'Tham Quan Vườn Theo Lịch Hẹn', desc: 'Đi qua vườn Palm Beach, đặt câu hỏi và tìm cây phù hợp.' },
    ],
  },
  finalCTA: {
  ...
  carePage: {
    label: 'Thư viện chăm sóc theo loài',
    heading: 'Hướng Dẫn Chăm Sóc Bonsai',
    description: 'Xem hướng dẫn chăm sóc theo từng loài cây, không phải theo từng cây đang bán.',
    searchPlaceholder: 'Tìm loài cây: Ficus, Bluebell, Juniper...',
    speciesList: 'Loài cây',
    speciesSingular: 'hướng dẫn loài',
    speciesPlural: 'hướng dẫn loài',
    lightLabel: 'Ánh sáng',
    waterLabel: 'Tưới nước',
    ...
    sections: {
      ...
      repotting: 'Thay chậu',
      watchFor: 'Cần chú ý',
      floridaTips: 'Mẹo ở Florida',
      weeklyChecklist: 'Việc cần kiểm tra hằng tuần',
    },
  },
  connectSimple: {
    label: 'Liên Hệ',
